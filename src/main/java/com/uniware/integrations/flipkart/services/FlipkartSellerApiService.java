...
public class FlipkartSellerApiService {
     ...
     */
    public ShipmentDetailsV3WithAddressResponse getShipmentDetailsWithAddress(List<String> shipmentIds) {
        ...
        headersMap.put("Content-Type", "application/json");
        headersMap.put("Authorization", FlipkartRequestContext.current().getAuthToken());
        String apiEndpoint = "/sellers/v3/shipments/" + commaSepratedShipmentIds;
        try {
            String response = httpSender.executeGet(channelBaseUrl + apiEndpoint, Collections.emptyMap(), headersMap, httpResponseWrapper);
            handleResponseCode(response, httpResponseWrapper);
     ...
     */
    public ShipmentDetailsV3WithSubPackages getShipmentDetailsWithSubPackages(List<String> shipmentIds) {
        ...
        params.put("shipmentIds", commaSepratedShipmentIds);
     ...
     */
    public InvoiceDetailsV3Response getInvoicesInfo(List<String> shipmentIds) {
        ...
        headersMap.put("Content-Type", "application/json");
        headersMap.put("Authorization", FlipkartRequestContext.current().getAuthToken());
        String apiEndpoint = "/sellers/v3/shipments/" + commaSepratedShipmentIds + "/invoices";
        try {
            String response = httpSender.executeGet(channelBaseUrl + apiEndpoint, Collections.emptyMap(), headersMap, httpResponseWrapper);
            handleResponseCode(response, httpResponseWrapper);
