...
public class FlipkartSellerPanelService {
    ...
    public boolean sellerPanelLogin(String userName, String password) {
        if(verifySession()){
            return true;
        }
        ...
        try {
            ...
            if (httpResponseWrapper.getResponseStatus().equals(HttpStatus.TOO_MANY_REQUESTS)) {
                ...
                if (StringUtils.isBlank(mpsEnabledResponse)) {
                    ...
                    return !mpsEnabledResponse.contains("DOCTYPE html");
                }
            }
        } catch (HttpTransportException | JsonSyntaxException e) {
    ...
    */
     ...
     */
    public void requestStockFile(EnqueDownloadRequest enqueDownloadRequest) {
